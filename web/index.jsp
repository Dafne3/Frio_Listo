...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %> <!-- esto importa fmt -->
<!DOCTYPE html>
<html lang="es">
  <head>
    <meta charset="utf-8">
  ...
  <body style="margin:0; padding-top:75px;">
    ...
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 px-4 fixed-top"
        ...
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="ProductoServlet?action=listar" class="nav-link px-2 fw-bold" style="color:#0bbca5;">Productos y servicios</a></li>
          <li><a href="contacto.jsp" class="nav-link px-2 fw-bold" style="color:#0bbca5;">Contacto</a></li>
        </ul>  

        <!-- Botones -->
        <div class="col-md-3 text-end">
            <c:if test="${not empty sessionScope.nombreUsuario}"> <!-- esto reemplaza el if de sesion -->
                <span class="text-white fw-bold me-3">
                    Hola, <c:out value="${sessionScope.nombreUsuario}"/> <c:out value="${sessionScope.apellidoUsuario}"/> <!-- esto reemplaza los out.print -->
                </span>
                <a href="logout.jsp" class="btn btn-danger">Salir</a>
            </c:if>
            <c:if test="${empty sessionScope.nombreUsuario}"> <!-- esto reemplaza el else -->
    ...
    <section class="py-5" style="background-color:#f8fbfd;">
      <div class="container text-center">
        ...
        <!-- Botón final -->
        <div class="mt-4">
          <a href="ProductoServlet?action=listar" class="btn btn-lg" style="background-color:#22a593; color:white; border:none;">Explorar bebidas</a>
        </div>
      </div>
    </section>
